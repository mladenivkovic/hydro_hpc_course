...
###########################
    ...
    fig1 = plt.figure(1, facecolor='white', figsize=(12,6))
    ...
    ax1.plot(nlw, tlw, 'r-', linewidth=0.1, label='linear domain', zorder=5) #lines linear
    ax1.plot(nlw, tlw, 'ro', markersize=2.5, markeredgecolor='r', zorder=5) # points linear
    ax1.plot(nsw, tsw, 'b-', linewidth=0.1, label='square domain', zorder=5) # lines square
...
###########################
    ...
    fig2 = plt.figure(2, facecolor='white', figsize=(12,6))
    ...
    ax1.semilogy(nls, tls, 'r-', linewidth=0.1, label='linear domain', zorder=5) # lines linear
    ax1.semilogy(nls, tls, 'ro', markersize=2.5, markeredgecolor='r', zorder=5) # points linear
    ax1.semilogy(nss, tss, 'b-', linewidth=0.1, label='square domain', zorder=5) # lines square
